...
INPUT_IMAGE=/cluster/project/cvg/students/shangwu/GEN3C/dummy_render
# INPUT_IMAGE=/cluster/project/cvg/students/shangwu/GEN3C/assets/diffusion/door.png
# INPUT_IMAGE=/cluster/project/cvg/students/shangwu/GEN3C/features_analysis/images/Actmap_MH3D_00004_211_1.jpg
...
OUT_DIR=features_analysis/outputs
mkdir -p "${OUT_DIR}"
...
# ---------------------------------------------------------------------------
# Run gen3c_frontier on explorable images only
# ---------------------------------------------------------------------------
echo ""
